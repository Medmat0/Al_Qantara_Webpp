...
const FRONTEND_URL = process.env.NGROK_URL || 'https://23a8-2a02-8428-8533-ea01-b80f-a38f-e50b-d6af.ngrok-free.app';
...
const createAdhesionCheckoutIntent = async (adhesionData) => {
  try {
    ...
    const backurl = "https://www.google.com/";
    const errorUrl = "https://facebook.com/";
    const returnUrl = "https://youtube.com/";
